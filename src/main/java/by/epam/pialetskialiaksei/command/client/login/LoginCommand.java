...
public class LoginCommand implements Command {
    ...
    public Response execute(HttpServletRequest request,
        ...
        try {
            ...
            User user = (User) userDAO.find(new FindUserByEmailAndPasswordCriteria(email, password)).getData();
            ...
            if (user == null) {
                ...
                result = new Response(Path.REDIRECT_LOGIN_PAGE, ActionType.POST);
            } else {
                ...
                result = new Response(Path.REDIRECT_TO_PROFILE, ActionType.POST);
            }
            return result;
