...
public class FriendDAO extends SqlDAO {
    public <T extends FriendCriteria & FindCriteria> DTO find(T criteria) throws DAOException {
        return super.find(criteria);
    }
    public <T extends FriendCriteria & DeleteCriteria> void delete(T criteria) throws DAOException {
        super.delete(criteria);
    }
    public <T extends FriendCriteria & UpdateCriteria> void update(T criteria) throws DAOException {
        super.update(criteria);
    }
    public <T extends FriendCriteria & InsertCriteria> void insert(T criteria) throws DAOException {
