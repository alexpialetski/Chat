...
public final class Path {
        ...
        public static final String FORWARD_CLIENT_PAGE = "/WEB-INF/view/client/user/view.jsp";
        public static final String REDIRECT_TO_VIEW_CLIENT= "controller?command=viewClient&id=*";
        ...
        public static final String REDIRECT_TO_ALL_CLIENTS = "controller?command=viewClients";
        public static final String FORWARD_ALL_CLIENTS = "/WEB-INF/view/client/user/viewAll.jsp";
